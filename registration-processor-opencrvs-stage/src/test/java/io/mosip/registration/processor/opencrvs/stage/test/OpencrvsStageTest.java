package io.mosip.registration.processor.opencrvs.stage.test;
...
public class OpencrvsStageTest {
	...
	@InjectMocks
	private OpencrvsStage stage = new OpencrvsStage() {
		@Override
	...
	public void setup() throws Exception {
		...
		when(env.getProperty("mosip.regproc.opencrvs.server.port")).thenReturn("8099");
	...
	public void testAll() throws Exception {
		testDeployVerticle();
        testStart();
        testOpencrvsStageSuccess();
		testOpencrvsStageFailure();
	}
	...
	@Test
	public void testOpencrvsStageSuccess()
	...
	@Test
	public void testOpencrvsStageFailure() throws ApisResourceAccessException {
